...
def login():
    ...
    # Cache credential hash → token (TTL 5 menit) untuk bypass bcrypt pada repeat login
...
def create_order():
    ...
    for item in d["items"]:
        ...
        # Atomik: kurangi stok HANYA jika stok mencukupi (1 MongoDB op, bukan read+write)
