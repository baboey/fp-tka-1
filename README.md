...
| 2  | Thio Billy Amansyah / 5027231007 & Arya Bisma Putra Refman / 5027241036 | **Backend Developer (Core)** | Melakukan migrasi kode backend produksi utama yang terintegrasi dengan JWT Auth dan Database. |
| 3  | Ahmad Yazid Arifuddin / 5027241040 | **Backend & Security Engineer** | Membuat API kompatibilitas frontend unauthenticated dan merancang logika validasi token JWT. |
| 4  | Muhammad Rakha Hananditya Rauf / 5027241015 | **Nginx & Frontend Integrator** | Mengintegrasikan static asset frontend ke server Nginx, merekayasa routing, dan menyelesaikan isu CORS. |
